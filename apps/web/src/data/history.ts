...
export interface Task {
  id: number;
  date: string; // 计划/完成日期，如 "2026-06-16"
...
/** 模拟「今天」日期，便于演示日/周/月视图 */
export const MOCK_TODAY = "2026-06-16";
...
/** 日视图标题：今天 / 昨天 / M月D日 */
export function formatDateLabel(dateStr: string, today = MOCK_TODAY): string {
